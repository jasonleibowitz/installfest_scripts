...
# Updated from Matthew Mueller's version at https://gist.github.com/MatthewMueller/e22d9840f9ea2fee4716
...
# Hibernation is no longer necessary - http://www.tuaw.com/2011/08/22/why-hibernate-or-safe-sleep-mode-is-no-longer-necessary-in-os/
echo ""
